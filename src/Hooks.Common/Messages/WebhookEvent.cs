...
/// <summary>
/// Class representing the generic webhook event payload.
/// </summary>
[EntityName("hooks.common.webhook-event")]
public class WebhookEvent
{
    /// <summary>
    /// The unique identifier of the customer for whom the message has been raised.
    /// </summary>
    public string CustomerId { get; private set; }
    
    /// <summary>
    /// An optional collection of unique office identifiers to limit the scope of message delivery for a customer. 
    /// </summary>
    public IEnumerable<string>? OfficeIds { get; private set; }
    
    /// <summary>
    /// The unique identifier of the entity associated with this message.
    /// </summary>
    public string EntityId { get; private set; }
    
    /// <summary>
    /// The type of entity associated with this message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="WebhookEvent"/>
    /// </summary>
